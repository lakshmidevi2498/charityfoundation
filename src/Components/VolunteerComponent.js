            ...
            <Controls.Grid conatiner justifyContent="center" mb={4} mt={1} pt={4}>
                <Controls.Grid item xs={12} sx={{ justifyContent: "center", textAlign: "center" }}>
                    <Controls.Typography variant='caption2' sx={{
                        fontFamily: 'Poppins', fontSize: {xs:"16px",sm:'32px'},
                        fontWeight: 500,
                    ...
                    <Controls.Grid container sx={{ textAlign: "center", justifyContent: "center" }} my={5}>
                        <Controls.Box sx={{ display: 'flex', alignItems: 'center' }} >
                            ...
                            <Controls.Divider sx={{ backgroundColor:"#107A66",  height: '1px', width: {xs:"50px",sm:"150px"},  }} />
                            <Controls.Button variant='contained' sx={{ backgroundColor: theme.palette.one.green, borderRadius: "10px", textTransform: "inherit",   paddingX: {xs:"5px",sm:"35px"},paddingY:"10px",fontSize:{xs:"10px",sm:"15px"} }}>Donate Funds</Controls.Button>
                        </Controls.Box>
                    </Controls.Grid>
                </Controls.Grid>
            </Controls.Grid>
