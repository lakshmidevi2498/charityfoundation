...
const FormicFormComponent = ({ initialValues, validationSchema, dispatch, data }) => {
                    ...
                    >
                        {({ errors, touched, isSubmitting, setFieldValue }) => (
                            <Form>
                                ...
                                <Controls.Grid item>
                                    <Controls.Grid item>
                                        <Controls.Typography variant='caption1' sx={{ color: theme.palette.one.green, fontWeight: "bold", fontSize: { xs: "15px", md: "20px" } }}>Support a cause and reduce your tax burden!</Controls.Typography>
                                    </Controls.Grid>
                                    <Controls.Grid item my={1}>
                                        <Controls.Typography variant='caption2' sx={{ color: theme.palette.one.green, fontWeight: "bold", fontSize: { xs: "20px", md: "25px" } }}>Citizenship*</Controls.Typography>
                                    </Controls.Grid>
                                    <Controls.Grid item>
                                        <Controls.FormControl>
                                            ...
                                            >
                                                <Controls.FormControlLabel
                                                    ...
                                                    control={<Controls.Radio sx={{ '& .MuiSvgIcon-root': { fontSize: 18 }, color: theme.palette.one.green, '&.Mui-checked': { color: theme.palette.one.green } }} />}
                                    ...
                                    <Controls.Grid item gap={5} display='flex' my={1}>
                                        <Controls.Grid item>
                                            <Controls.Button
                                    ...
                                    <Controls.Grid item>
                                        <Controls.Typography variant='caption1' sx={{ fontSize: "20px", fontWeight: "bold" }}>Choose amount to Donate :</Controls.Typography>
                                    </Controls.Grid>
                                    <Controls.Grid item gap={4} display={{xs:"block",sm:'flex'}} my={1}>
