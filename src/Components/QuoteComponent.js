  ...
  return (
    ...
    <Controls.Grid container justifyContent='center'>
        <Controls.Grid item xs={11} lg={10} sx={{justifyContent:"center",textAlign:"center",padding:"20px"}}>
            ...
            <Controls.Typography variant='caption1' sx={{fontSize:{xs:"14px",sm:"18px",md:"20px",xl:'32px'},fontWeight:"medium"}}>The purpose of life is not to be happy. It is to be useful, to be honourable, to be compassionate, to have it make some difference that you have lived and lived well.</Controls.Typography>
            </Controls.Grid>
